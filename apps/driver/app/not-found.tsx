...
export default function DriverNotFound(): ReactElement {
  return (
    <main className="bg-background safe-top safe-bottom flex min-h-dvh items-center justify-center px-4 py-12">
